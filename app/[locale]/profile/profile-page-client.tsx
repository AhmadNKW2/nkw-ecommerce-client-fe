    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="hidden lg:block bg-white rounded-xl p-6 shadow-sm border border-gray-100 group hover:border-danger/30 transition-colors">
          <div className="flex items-start justify-between">
            <div>
              ...
              <div className="text-3xl font-bold text-gray-900 mb-1">{wishlistItems.length}</div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 relative hover:border-secondary/30 transition-colors">
          <div className="flex items-start justify-between mb-4">
            ...
            <Link href="/profile/addresses" className="text-sm text-gray-400 hover:text-primary">
              {tCommon("edit")}
            </Link>
          </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="p-6 border-b border-gray-100 flex items-center justify-between">
          ...
          <Link href="/profile/orders" className="text-sm text-secondary font-medium hover:underline">
            {tCommon("viewAll")}
          </Link>
        </div>
