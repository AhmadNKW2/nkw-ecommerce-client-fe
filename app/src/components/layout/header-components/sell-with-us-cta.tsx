...
const sellWithUsCopy = {
  en: {
    ...
    fields: {
      ...
      companyName: {
        ...
        placeholder: "Enter your company name if you have one",
      },
    },
    validation: {
      fullName: "Please enter your full name.",
      phone: "Please enter a valid phone number.",
      companyName: "If provided, enter a valid company name.",
    },
  ...
  ar: {
    ...
    validation: {
      ...
      companyName: "إذا أدخلت اسم الشركة، فيرجى أن يكون صالحاً.",
    },
    submit: "إرسال الطلب",
